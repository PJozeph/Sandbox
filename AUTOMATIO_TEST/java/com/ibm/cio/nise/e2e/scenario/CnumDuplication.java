...
public class CnumDuplication {

	private Validator validator;
	private UploadFilePage uploadFilePage;

	// For PicoContainer
	public CnumDuplication() {
	}

	public CnumDuplication(TestContext testContext) {
	...
	@When("^I submit xml with duplicated CNUM \"([^\"]*)\"$")
	public void when(String file) {
		uploadFilePage.uploadXML(file);
	}

	@Then("^I see CNUM duplication validation message \"([^\"]*)\"$")
